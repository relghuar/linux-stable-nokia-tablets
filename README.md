...
This branch is based on linux-stable-rc 6.1.x, with additional changes for Nokia N810 internet tablet device (possibly N800 as well?).
...
## NEW :: issues while updating patches from 5.15
