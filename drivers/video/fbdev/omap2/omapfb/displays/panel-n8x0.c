...
static int n8x0_panel_probe_pdata(struct spi_device *spi)
{
	const struct panel_n8x0_platform_data *pdata;
	...
	ddata->powerdown_gpio = pdata->powerdown_gpio;
...
static int n8x0_panel_probe(struct spi_device *spi)
{
	...
	// FIXME: TODO: this is commented out because of qemu - on real N810 it works fine!
	// On qemu, even panel_detect can NOT be called twice in sequence - second call
